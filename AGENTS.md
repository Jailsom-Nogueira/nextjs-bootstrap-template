...
| SEO / metadata / icons / social previews | `.agents/rules/seo.md`; `accessibility.md` + visual QA for icon/OG image work. Metadata is assembled only via `buildMetadata` (`src/lib/seo/`).  | `npm run qa`; `npm run qa:visual` for icon/OG image changes.                                                      |
